...
base64, save it to a file and check if 2 identical keys appeared.
4. Repeat 3. but use the openssl-random-number generator.
5. Repeat 3. but use the QNRG-resource from 1.
